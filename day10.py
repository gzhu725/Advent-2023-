#graph theory? needed hyper neutrino!!
...
print(len(grid) * len(grid[0]) - len(outside | loop)) #Part 2
#end of new part two code
print(len(loop) // 2) #part 1 without the if statements
